...
function tabRenalAKI(el_) {
  ...
  el_.appendChild(card('📊 KDIGO AKI Staging','#7c3aed',
    '<table><thead><tr style="background:#faf5ff"><th>Stage</th><th>Serum Creatinine Criteria</th><th>Urine Output Criteria</th><th>Action</th></tr></thead><tbody>'+[
  ...
  el_.appendChild(card('⚠️ STOP These in AKI — Nephrotoxin Avoidance','#dc2626',
    '<table><thead><tr style="background:#fef2f2"><th>Drug / Substance</th><th>Action</th></tr></thead><tbody>'+[
...
function tabRenalCKD(el_) {
  ...
  el_.appendChild(card('GFR Categories (G1\u2013G5)','#7c3aed','<div style="overflow-x:auto"><table><thead><tr style="background:#faf5ff"><th>Stage</th><th>eGFR (mL/min/1.73m\u00b2)</th><th>Description</th><th>Key Actions</th></tr></thead><tbody>'
  ...
  el_.appendChild(card('Albuminuria Categories (A1\u2013A3)','#0ea5e9','<div style="overflow-x:auto"><table><thead><tr style="background:#f0f9ff"><th>Category</th><th>ACR (mg/mmol)</th><th>ACR (mg/g)</th><th>Description</th></tr></thead><tbody>'
...
function tabRenalComplications(el_) {
  ...
  el_.appendChild(card('CKD-Mineral Bone Disease (CKD-MBD)','#f97316','<div style="overflow-x:auto"><table><thead><tr style="background:#fff7ed"><th>Parameter</th><th>Target / Goal</th><th>Management</th></tr></thead><tbody>'
...
function tabRenalDialysis(el_) {
  ...
  el_.appendChild(card('Dialysis Modalities \u2014 Comparison','#7c3aed','<div style="overflow-x:auto"><table><thead><tr style="background:#faf5ff"><th>Modality</th><th>Full Name</th><th>Setting</th><th>Best For</th></tr></thead><tbody>'
...
function tabRenalDrugs(el_) {
  ...
  el_.appendChild(card('Common Drugs \u2014 CKD Dose Adjustments','#7c3aed','<div style="overflow-x:auto"><table><thead><tr style="background:#faf5ff"><th>Drug</th><th>eGFR \u226560</th><th>eGFR 30\u201359</th><th>eGFR 15\u201329</th><th>eGFR <15 / Dialysis</th></tr></thead><tbody>'
