...
function tabPaedNormals(el_) {
  ...
  el_.appendChild(card('Normal Vital Signs by Age','#06b6d4','<div style="overflow-x:auto"><table><thead><tr style="background:#ecfeff"><th>Age Group</th><th>HR (bpm)</th><th>RR (breaths/min)</th><th>SBP (mmHg)</th><th>DBP (mmHg)</th></tr></thead><tbody>'
  ...
  el_.appendChild(card('Paediatric Hypertension \u2014 AAP 2017 Staging','#dc2626','<div style="overflow-x:auto"><table><thead><tr style="background:#fef2f2"><th>Category</th><th>Definition</th><th>Action</th></tr></thead><tbody>'
  ...
  el_.appendChild(card('Normal Blood Glucose Ranges (Children)','#16a34a','<div style="overflow-x:auto"><table><thead><tr style="background:#f0fdf4"><th>Age / State</th><th>mg/dL</th><th>mmol/L</th></tr></thead><tbody>'
...
function tabPaedFluids(el_) {
  ...
  el_.appendChild(card('Fluid Choice (NICE NG29)','#06b6d4','<table><thead><tr style="background:#ecfeff"><th>Situation</th><th>Fluid of Choice</th><th>Rate</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:600">'+r[0]+'</td><td style="color:#0891b2;font-weight:600">'+r[1]+'</td><td style="font-size:12px">'+r[2]+'</td></tr>';}).join('')+'</tbody></table>'));
}
...
function tabPaedAssessment(el_) {
  ...
  el_.appendChild(card('Fever Assessment \u2014 NICE Traffic Light (NG143)','#f97316','<div style="overflow-x:auto"><table><thead><tr style="background:#fff7ed"><th>Feature</th><th>\ud83d\udfe2 Low Risk</th><th>\ud83d\udfe1 Intermediate Risk</th><th>\ud83d\udd34 High Risk</th></tr></thead><tbody>'
...
function tabPaedMalaria(el_) {
  ...
  el_.appendChild(card('💉 IV Artesunate Protocol — Severe Malaria (All Ages)','#0ea5e9',
    ...
    '<table><thead><tr style="background:#f0f9ff"><th>Parameter</th><th>Detail</th></tr></thead><tbody>' +
    [
  ...
  el_.appendChild(card('💊 Artemether-Lumefantrine (Coartem) — Uncomplicated Malaria Dosing','#16a34a',
    ...
    '<table><thead><tr style="background:#f0fdf4"><th>Weight</th><th>Tablets per dose</th><th>Schedule</th></tr></thead><tbody>' +
    [
    ...
    '</tbody></table><p style="font-size:11px;color:#64748b;margin-top:8px">Each tablet = Artemether 20mg + Lumefantrine 120mg. Not for infants <5 kg or <1 month.</p>'
  ));

  el_.appendChild(card('⚠️ Quinine — Second-Line (When Artesunate Unavailable)','#f97316',
    '<table><thead><tr style="background:#fff7ed"><th>Parameter</th><th>Detail</th></tr></thead><tbody>' +
    [
  ...
  el_.appendChild(card('🦠 Typhoid Fever in Children','#dc2626',
    ...
    '<table><thead><tr style="background:#fef2f2"><th>Severity</th><th>Treatment</th><th>Duration</th></tr></thead><tbody>' +
    [
    ...
    '</tbody></table><p style="font-size:11px;color:#64748b;margin-top:8px">⚠️ Complications: intestinal perforation (surgical emergency), typhoid encephalopathy, haemorrhage, hepatitis. Dexamethasone 3 mg/kg loading then 1 mg/kg 6-hourly × 48hr for severe encephalopathy (Hoffman 1984).</p>'
  ));
}
...
function tabPaedConvulsions(el_) {
  ...
  el_.appendChild(card('💊 Weight-Based Drug Doses — Convulsions','#0ea5e9',
    '<table><thead><tr style="background:#f0f9ff"><th>Drug</th><th>Dose</th><th>Route</th><th>Max</th></tr></thead><tbody>' +
    [
  ...
  el_.appendChild(card('🌡️ Febrile Convulsions — Assessment & Management','#16a34a',
    ...
    '<table><thead><tr style="background:#f0fdf4"><th>Feature</th><th>Simple FC</th><th>Complex FC — Investigate</th></tr></thead><tbody>' +
    [
...
function tabPaedMalnutrition(el_) {
  ...
  el_.appendChild(card('🥛 Therapeutic Feeds — F-75, F-100, RUTF','#16a34a',
    '<table><thead><tr style="background:#f0fdf4"><th>Feed</th><th>When</th><th>Energy</th><th>Volume</th></tr></thead><tbody>' +
    [
...
function tabPaedSickleCell(el_) {
  ...
  el_.appendChild(card('🫁 Acute Chest Syndrome (ACS) — Emergency','#dc2626',
    ...
    '<table><thead><tr style="background:#fef2f2"><th>Action</th><th>Detail</th></tr></thead><tbody>' +
    [
  ...
  el_.appendChild(card('💊 Infection in SCD — Prevention & Treatment','#16a34a',
    '<table><thead><tr style="background:#f0fdf4"><th>Intervention</th><th>Detail</th><th>Duration</th></tr></thead><tbody>' +
    [
  ...
  el_.appendChild(card('📊 Transfusion Thresholds in SCD','#0ea5e9',
    '<table><thead><tr style="background:#f0f9ff"><th>Situation</th><th>Threshold</th><th>Target Hb</th><th>Type</th></tr></thead><tbody>' +
    [
