...
function tabHypoPrev(el_) {
  ...
  el_.appendChild(card('High-Risk Medications to Review','#a855f7','<table><thead><tr style="background:#faf5ff"><th>Drug Class</th><th>Risk</th><th>Prevention Strategy</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:600">'+r[0]+'</td><td style="color:#dc2626;font-size:12px">'+r[1]+'</td><td style="font-size:12px">'+r[2]+'</td></tr>';}).join('')+'</tbody></table>'));
  ...
  el_.appendChild(card('Who Needs Extra Vigilance','#a855f7','<table><thead><tr style="background:#faf5ff"><th>Population</th><th>Key Risk</th><th>Prevention Focus</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#7c3aed">'+r[0]+'</td><td style="font-size:12px;color:#dc2626">'+r[1]+'</td><td style="font-size:12px">'+r[2]+'</td></tr>';}).join('')+'</tbody></table>'));
...
function tabHypoClass(el_) {
  ...
  document.getElementById('hy-btn').onclick=function(){
    ...
    if(_hyInv.length){
      ...
      _hyInvHtml+='</div>';
      _hyInvHtml+='<table style="width:100%;border-collapse:collapse">';
...
function tabHypoEval(el_) {
  ...
  el_.appendChild(card('First-Line Bloods — All Hypotension Presentations','#a855f7','<table><thead><tr style="background:#faf5ff"><th>Test</th><th>What to Look For</th><th>Clinical Significance</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:600">'+r[0]+'</td><td style="color:#7c3aed;font-size:12px">'+r[1]+'</td><td style="font-size:12px">'+r[2]+'</td></tr>';}).join('')+'</tbody></table>'));
  el_.appendChild(card('Additional Targeted Investigations','#a855f7','<table><thead><tr style="background:#faf5ff"><th>Clinical Suspicion</th><th>Investigation</th><th>Target Finding</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:600">'+r[0]+'</td><td style="color:#a855f7;font-weight:600">'+r[1]+'</td><td style="font-size:12px">'+r[2]+'</td></tr>';}).join('')+'</tbody></table>'));
}
...
function tabShock(el_) {
  ...
  el_.appendChild(card('Agent Selection by Shock Type','#dc2626','<table><thead><tr style="background:#fef2f2"><th>Agent</th><th>Mechanism</th><th>First-Line For</th><th>Notes</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700">'+r[0]+'</td><td>'+r[1]+'</td><td style="color:#dc2626;font-weight:600">'+r[2]+'</td><td style="font-size:12px">'+r[3]+'</td></tr>';}).join('')+'</tbody></table>'));
