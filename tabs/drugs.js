...
function tabDrugPsychiatry(el_) {
  ...
  el_.appendChild(card('Typical Antipsychotics (First Generation)','#8b5cf6','<table><thead><tr style="background:#faf5ff"><th>Drug</th><th>Dose Range</th><th>Route</th><th>Metabolic Risk</th><th>Key Cautions</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#8b5cf6">'+r[0]+'</td><td>'+r[1]+'</td><td>'+r[2]+'</td><td style="font-size:12px;color:#d97706">'+r[3]+'</td><td style="font-size:12px">'+r[4]+'</td></tr>';}).join('')+'</tbody></table>'));

  // ── Atypical Antipsychotics ──
  el_.appendChild(card('Atypical Antipsychotics (Second Generation) — Metabolic Risk Ranked','#7c3aed','<table><thead><tr style="background:#f5f3ff"><th>Drug</th><th>Dose Range</th><th>Weight Gain</th><th>DM Risk</th><th>Dyslipidaemia</th><th>BP Effect</th></tr></thead><tbody>'+[
  ...
  }).join('')+'</tbody></table><p style="font-size:11px;color:#64748b;margin-top:6px">+ = low risk, ++ = moderate, +++ = high, ++++ = very high. Source: Maudsley Prescribing Guidelines 14th ed.</p>'));

  // ── Metabolic Monitoring ──
  el_.appendChild(card('Mandatory Metabolic Monitoring — Antipsychotics','#dc2626','<table><thead><tr style="background:#fef2f2"><th>Parameter</th><th>Baseline</th><th>4–6 Weeks</th><th>3 Months</th><th>Annually</th></tr></thead><tbody>'+[
    ['Weight / BMI','✓','✓','✓','✓'],
    ['Waist circumference','✓','—','✓','✓'],
    ['Blood pressure','✓','✓','✓','✓'],
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:600">'+r[0]+'</td><td style="text-align:center;color:#16a34a;font-weight:700">'+r[1]+'</td><td style="text-align:center;font-size:12px">'+r[2]+'</td><td style="text-align:center;font-size:12px">'+r[3]+'</td><td style="text-align:center;font-size:12px">'+r[4]+'</td></tr>';}).join('')+'</tbody></table><p style="font-size:11px;color:#64748b;margin-top:6px">Source: NICE NG185, Maudsley Guidelines 14th ed. Clozapine FBC monitoring is legally mandated in most jurisdictions.</p>'));

  // ── Mood Stabilisers ──
  el_.appendChild(card('Mood Stabilisers','#0891b2','<table><thead><tr style="background:#f0f9ff"><th>Drug</th><th>Dose Range</th><th>Monitoring</th><th>Metabolic Effects</th><th>Interactions with HTN/DM drugs</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#0891b2">'+r[0]+'</td><td style="font-size:12px">'+r[1]+'</td><td style="font-size:12px">'+r[2]+'</td><td style="font-size:12px;color:#d97706">'+r[3]+'</td><td style="font-size:12px;color:#dc2626">'+r[4]+'</td></tr>';}).join('')+'</tbody></table>'));

  // ── Antidepressants ──
  el_.appendChild(card('Antidepressants — Metabolic & Cardiovascular Effects','#0ea5e9','<table><thead><tr style="background:#f0f9ff"><th>Class / Drug</th><th>BP Effect</th><th>Weight Effect</th><th>DM Risk</th><th>Key Caution</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:600">'+r[0]+'</td><td style="font-size:12px;color:#dc2626">'+r[1]+'</td><td style="font-size:12px;color:#d97706">'+r[2]+'</td><td style="font-size:12px">'+r[3]+'</td><td style="font-size:12px">'+r[4]+'</td></tr>';}).join('')+'</tbody></table>'));
...
function tabDrugAntihypertensives(el_) {
  ...
  el_.appendChild(card('🫘 Renal Dose Flags — Key Antihypertensives in CKD','#dc2626','<table><thead><tr style="background:#fef2f2"><th>Drug / Class</th><th>CKD Stage 3 (eGFR 30–59)</th><th>CKD Stage 4–5 (eGFR &lt;30)</th><th>Key Risk</th></tr></thead><tbody>'+[
  ...
  }).join('')+'</tbody></table><p style="font-size:11px;color:#64748b;margin-top:8px">Triple Whammy Warning: ACEi/ARB + Diuretic + NSAID = high AKI risk. Avoid NSAIDs in any CKD patient on antihypertensives. Source: ESC/ESH 2023, BNF.</p>'));

  el_.appendChild(card('ACE Inhibitors','#0ea5e9','<table><thead><tr style="background:#f0f9ff"><th>Drug</th><th>Starting Dose</th><th>Max Dose</th><th>Frequency</th><th>Key Cautions</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#0ea5e9">'+r[0]+'</td><td>'+r[1]+'</td><td>'+r[2]+'</td><td>'+r[3]+'</td><td style="font-size:12px">'+r[4]+'</td></tr>';}).join('')+'</tbody></table>'));

  el_.appendChild(card('ARBs (Angiotensin Receptor Blockers)','#06b6d4','<table><thead><tr style="background:#f0fdfa"><th>Drug</th><th>Starting Dose</th><th>Max Dose</th><th>Frequency</th><th>Key Cautions</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#06b6d4">'+r[0]+'</td><td>'+r[1]+'</td><td>'+r[2]+'</td><td>'+r[3]+'</td><td style="font-size:12px">'+r[4]+'</td></tr>';}).join('')+'</tbody></table>'));

  el_.appendChild(card('Calcium Channel Blockers (CCBs)','#8b5cf6','<table><thead><tr style="background:#faf5ff"><th>Drug</th><th>Starting Dose</th><th>Max Dose</th><th>Frequency</th><th>Key Cautions</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#8b5cf6">'+r[0]+'</td><td>'+r[1]+'</td><td>'+r[2]+'</td><td>'+r[3]+'</td><td style="font-size:12px">'+r[4]+'</td></tr>';}).join('')+'</tbody></table>'));

  el_.appendChild(card('Diuretics','#16a34a','<table><thead><tr style="background:#f0fdf4"><th>Drug</th><th>Starting Dose</th><th>Max Dose</th><th>Frequency</th><th>Key Cautions</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#16a34a">'+r[0]+'</td><td>'+r[1]+'</td><td>'+r[2]+'</td><td>'+r[3]+'</td><td style="font-size:12px">'+r[4]+'</td></tr>';}).join('')+'</tbody></table>'));

  el_.appendChild(card('Beta-Blockers','#d97706','<table><thead><tr style="background:#fffbeb"><th>Drug</th><th>Starting Dose</th><th>Max Dose</th><th>Frequency</th><th>Key Cautions</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#d97706">'+r[0]+'</td><td>'+r[1]+'</td><td>'+r[2]+'</td><td>'+r[3]+'</td><td style="font-size:12px">'+r[4]+'</td></tr>';}).join('')+'</tbody></table>'));

  el_.appendChild(card('IV Agents — Hypertensive Emergency','#dc2626','<table><thead><tr style="background:#fef2f2"><th>Drug</th><th>IV Dose</th><th>Onset</th><th>Notes</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#dc2626">'+r[0]+'</td><td>'+r[1]+'</td><td>'+r[2]+'</td><td style="font-size:12px">'+r[3]+'</td></tr>';}).join('')+'</tbody></table>'));
}
...
function tabDrugAntidiabetics(el_) {
  ...
  }).join('')+'</tbody></table><p style="font-size:11px;color:#64748b;margin-top:8px">⚠️ Always check current eGFR before prescribing. eGFR should be rechecked at least annually in all DM patients, or after any acute illness. Source: ADA 2024, BNF, KDIGO 2022.</p>'));

  el_.appendChild(card('Biguanides','#ef4444','<table><thead><tr style="background:#fef2f2"><th>Drug</th><th>Starting</th><th>Max</th><th>Freq</th><th>Notes</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#ef4444">'+r[0]+'</td><td>'+r[1]+'</td><td>'+r[2]+'</td><td>'+r[3]+'</td><td style="font-size:12px">'+r[4]+'</td></tr>';}).join('')+'</tbody></table>'));

  el_.appendChild(card('SGLT2 Inhibitors (Gliflozins)','#0ea5e9','<table><thead><tr style="background:#f0f9ff"><th>Drug</th><th>Dose</th><th>Freq</th><th>CV/Renal Benefit</th><th>Cautions</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#0ea5e9">'+r[0]+'</td><td>'+r[1]+'</td><td>'+r[2]+'</td><td style="font-size:12px">'+r[3]+'</td><td style="font-size:12px">'+r[4]+'</td></tr>';}).join('')+'</tbody></table>'));

  el_.appendChild(card('GLP-1 Receptor Agonists','#16a34a','<table><thead><tr style="background:#f0fdf4"><th>Drug</th><th>Dose</th><th>Freq</th><th>CV Benefit</th><th>Notes</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#16a34a">'+r[0]+'</td><td>'+r[1]+'</td><td>'+r[2]+'</td><td style="font-size:12px">'+r[3]+'</td><td style="font-size:12px">'+r[4]+'</td></tr>';}).join('')+'</tbody></table>'));

  el_.appendChild(card('Sulfonylureas','#d97706','<table><thead><tr style="background:#fffbeb"><th>Drug</th><th>Starting</th><th>Max</th><th>Freq</th><th>Cautions</th></tr></thead><tbody>'+[
  ...
  el_.appendChild(card('DPP-4 Inhibitors (Gliptins)','#8b5cf6','<table><thead><tr style="background:#faf5ff"><th>Drug</th><th>Dose</th><th>Freq</th><th>Renal Adjustment</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#8b5cf6">'+r[0]+'</td><td>'+r[1]+'</td><td>'+r[2]+'</td><td style="font-size:12px">'+r[3]+'</td></tr>';}).join('')+'</tbody></table>'));
}
...
function tabDrugInsulinCalc(el_) {
  ...
  el_.appendChild(card('Insulin Types — Nigeria Ward Reference','#f59e0b',
    '<table><thead><tr style="background:#fffbeb"><th>Insulin</th><th>Type</th><th>Onset</th><th>Peak</th><th>Duration</th><th>Main Use</th></tr></thead><tbody>'+[
...
function tabDrugEmergencyMeds(el_) {
  ...
  el_.appendChild(card('Resuscitation Drugs','#dc2626','<table><thead><tr style="background:#fef2f2"><th>Drug</th><th>Indication</th><th>Adult Dose</th><th>Route</th><th>Notes</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#dc2626">'+r[0]+'</td><td>'+r[1]+'</td><td>'+r[2]+'</td><td>'+r[3]+'</td><td style="font-size:12px">'+r[4]+'</td></tr>';}).join('')+'</tbody></table>'));

  el_.appendChild(card('Seizure Management','#8b5cf6','<table><thead><tr style="background:#faf5ff"><th>Drug</th><th>Dose</th><th>Route</th><th>When</th><th>Notes</th></tr></thead><tbody>'+[
  ...
  el_.appendChild(card('Reversal Agents','#16a34a','<table><thead><tr style="background:#f0fdf4"><th>Reversal Agent</th><th>Reverses</th><th>Dose</th><th>Route</th><th>Notes</th></tr></thead><tbody>'+[
  ...
  el_.appendChild(card('Additional Emergency Drug Reference','#dc2626','<table><thead><tr style="background:#fef2f2"><th>Drug</th><th>Indication</th><th>Dose</th><th>Notes</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#dc2626;font-size:13px">'+r[0]+'</td><td style="font-size:12px">'+r[1]+'</td><td style="font-size:12px">'+r[2]+'</td><td style="font-size:11px;color:#6b7280">'+r[3]+'</td></tr>';}).join('')+'</tbody></table>'));
}
...
function tabDrugFluids(el_) {
  ...
  el_.appendChild(card('Common IV Fluids — Composition','#06b6d4','<table><thead><tr style="background:#f0fdfa"><th>Fluid</th><th>Na⁺ (mmol/L)</th><th>K⁺</th><th>Cl⁻</th><th>pH</th><th>Osmolality</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#06b6d4">'+r[0]+'</td><td>'+r[1]+'</td><td>'+r[2]+'</td><td>'+r[3]+'</td><td>'+r[4]+'</td><td style="font-size:12px">'+r[5]+'</td></tr>';}).join('')+'</tbody></table>'));

  el_.appendChild(card('Clinical Indications','#0ea5e9','<table><thead><tr style="background:#f0f9ff"><th>Fluid</th><th>Use it when...</th><th>Avoid when...</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#0ea5e9">'+r[0]+'</td><td style="font-size:12px">'+r[1]+'</td><td style="font-size:12px;color:#ef4444">'+r[2]+'</td></tr>';}).join('')+'</tbody></table>'));
  ...
  el_.appendChild(card('Colloids','#06b6d4','<table><thead><tr style="background:#f0fdfa"><th>Colloid</th><th>Indication</th><th>Dose</th><th>Caution</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#06b6d4;font-size:13px">'+r[0]+'</td><td style="font-size:12px">'+r[1]+'</td><td style="font-size:12px">'+r[2]+'</td><td style="font-size:11px;color:#dc2626">'+r[3]+'</td></tr>';}).join('')+'</tbody></table>'));
  el_.appendChild(card('Blood Products — Quick Reference','#06b6d4','<table><thead><tr style="background:#f0fdfa"><th>Product</th><th>Indication</th><th>Dose</th><th>Notes</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#06b6d4;font-size:13px">'+r[0]+'</td><td style="font-size:12px">'+r[1]+'</td><td style="font-size:12px">'+r[2]+'</td><td style="font-size:11px;color:#6b7280">'+r[3]+'</td></tr>';}).join('')+'</tbody></table>'));
}
...
function tabDrugPregnancy(el_) {
  ...
  el_.appendChild(card('Antihypertensives in Pregnancy','#ec4899','<table><thead><tr style="background:#fdf2f8"><th>Drug</th><th>Safety</th><th>Notes</th></tr></thead><tbody>'+[
  ...
  el_.appendChild(card('Antidiabetics in Pregnancy','#f59e0b','<table><thead><tr style="background:#fffbeb"><th>Drug</th><th>Safety</th><th>Notes</th></tr></thead><tbody>'+[
  ...
  el_.appendChild(card('Other Common Drugs in Pregnancy','#64748b','<table><thead><tr style="background:#f8fafc"><th>Drug</th><th>Safety</th><th>Notes</th></tr></thead><tbody>'+[
...
function tabDrugAntibiotics(el_) {
  ...
  el_.appendChild(card('Community-Acquired Pneumonia (CAP)','#16a34a','<table><thead><tr style="background:#f0fdf4"><th>Severity</th><th>First-Line</th><th>Penicillin Allergy</th><th>Duration</th><th>Notes</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-size:12px">'+r[0]+'</td><td style="font-weight:600;font-size:12px;color:#16a34a">'+r[1]+'</td><td style="font-size:11px;color:#64748b">'+r[2]+'</td><td style="font-weight:700;color:#16a34a;font-size:12px">'+r[3]+'</td><td style="font-size:11px">'+r[4]+'</td></tr>';}).join('')+'</tbody></table>'));
  ...
  el_.appendChild(card('UTI — By Type & Severity','#0891b2','<table><thead><tr style="background:#f0f9ff"><th>Type</th><th>First-Line</th><th>Alternative / Allergy</th><th>Duration</th><th>Notes</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-size:12px;font-weight:600">'+r[0]+'</td><td style="font-weight:600;font-size:12px;color:#0891b2">'+r[1]+'</td><td style="font-size:11px;color:#64748b">'+r[2]+'</td><td style="font-weight:700;color:#0891b2;font-size:12px">'+r[3]+'</td><td style="font-size:11px">'+r[4]+'</td></tr>';}).join('')+'</tbody></table>'));
  ...
  el_.appendChild(card('SSTI, Diabetic Foot, Meningitis, Sepsis Empirical','#ea580c','<table><thead><tr style="background:#fff7ed"><th>Infection</th><th>First-Line</th><th>Notes / Allergy Alternative</th><th>Duration</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-size:12px;font-weight:700;color:#ea580c">'+r[0]+'</td><td style="font-weight:600;font-size:12px">'+r[1]+'</td><td style="font-size:11px;color:#64748b">'+r[2]+'</td><td style="font-weight:700;color:#ea580c;font-size:11px">'+(r[3]||'')+'</td></tr>';}).join('')+'</tbody></table>'));
  ...
  el_.appendChild(card('Expanded Antibiotics, Antifungals & Antivirals','#16a34a','<table><thead><tr style="background:#f0fdf4"><th>Drug</th><th>Indication</th><th>Adult Dose</th><th>Key Notes</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#16a34a;font-size:13px">'+r[0]+'</td><td style="font-size:12px">'+r[1]+'</td><td style="font-size:12px">'+r[2]+'</td><td style="font-size:11px;color:#6b7280">'+r[3]+'</td></tr>';}).join('')+'</tbody></table>'));
}
...
function tabDrugElectrolytes(el_) {
  ...
  el_.appendChild(card('Hypokalaemia — Causes, ECG Changes & Treatment','#d97706','<div style="font-size:13px;color:#374151">'+
    ...
    '<table style="width:100%;font-size:12px"><thead><tr style="background:#fffbeb"><th>K⁺ Level</th><th>Severity</th><th>Route</th><th>Replacement Regimen</th><th>Monitor</th></tr></thead><tbody>'+[
    ...
    ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#d97706">'+r[0]+'</td><td>'+r[1]+'</td><td>'+r[2]+'</td><td>'+r[3]+'</td><td style="font-size:11px;color:#64748b">'+r[4]+'</td></tr>';}).join('')+'</tbody></table>'+
  ...
  el_.appendChild(card('Hyponatraemia — Classification & Management','#7c3aed','<div style="font-size:13px;color:#374151">'+
    '<table style="width:100%;margin-bottom:12px"><thead><tr style="background:#faf5ff"><th>Na⁺ Level</th><th>Severity</th><th>Symptoms</th><th>Urgency</th></tr></thead><tbody>'+[
    ...
    ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#7c3aed">'+r[0]+'</td><td>'+r[1]+'</td><td>'+r[2]+'</td><td style="font-weight:700;color:'+([2].indexOf(['130–134','125–129','< 125'].indexOf(r[0]))>=0?'#dc2626':'#d97706')+'">'+r[3]+'</td></tr>';}).join('')+'</tbody></table>'+
    '<div class="g2" style="margin-bottom:12px">'+
...
function tabDrugAnalgesics(el_) {
  ...
  el_.appendChild(card('Non-Opioid Analgesics','#f43f5e','<table><thead><tr style="background:#fff1f2"><th>Drug</th><th>Dose</th><th>Max/Day</th><th>Frequency</th><th>Key Notes</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#f43f5e">'+r[0]+'</td><td>'+r[1]+'</td><td style="color:#dc2626;font-weight:600">'+r[2]+'</td><td>'+r[3]+'</td><td style="font-size:12px">'+r[4]+'</td></tr>';}).join('')+'</tbody></table>'));

  el_.appendChild(card('Opioid Analgesics','#dc2626','<table><thead><tr style="background:#fef2f2"><th>Drug</th><th>Dose</th><th>Route</th><th>Frequency</th><th>Key Notes</th></tr></thead><tbody>'+[
  ...
  el_.appendChild(card('Neuropathic Pain Agents','#8b5cf6','<table><thead><tr style="background:#faf5ff"><th>Drug</th><th>Starting Dose</th><th>Max Dose</th><th>Frequency</th><th>Key Notes</th></tr></thead><tbody>'+[
  ...
  el_.appendChild(card('Migraine & Headache','#f97316','<table><thead><tr style="background:#fff7ed"><th>Drug</th><th>Dose</th><th>Route</th><th>Notes</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#f97316">'+r[0]+'</td><td>'+r[1]+'</td><td>'+r[2]+'</td><td style="font-size:12px">'+r[3]+'</td></tr>';}).join('')+'</tbody></table>'));
}
...
function tabDrugRespGI(el_) {
  ...
  el_.appendChild(card('Respiratory — Inhalers & Bronchodilators','#10b981','<table><thead><tr style="background:#f0fdf4"><th>Drug</th><th>Class</th><th>Dose / Device</th><th>Frequency</th><th>Key Notes</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#10b981">'+r[0]+'</td><td style="font-size:12px;color:#6b7280">'+r[1]+'</td><td>'+r[2]+'</td><td>'+r[3]+'</td><td style="font-size:12px">'+r[4]+'</td></tr>';}).join('')+'</tbody></table>'));

  el_.appendChild(card('GI — Antiemetics','#f59e0b','<table><thead><tr style="background:#fffbeb"><th>Drug</th><th>Dose</th><th>Route</th><th>Frequency</th><th>Key Notes</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#f59e0b">'+r[0]+'</td><td>'+r[1]+'</td><td>'+r[2]+'</td><td>'+r[3]+'</td><td style="font-size:12px">'+r[4]+'</td></tr>';}).join('')+'</tbody></table>'));

  el_.appendChild(card('GI — Acid Suppression & GI Motility','#06b6d4','<table><thead><tr style="background:#ecfeff"><th>Drug</th><th>Dose</th><th>Frequency</th><th>Key Notes</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#06b6d4">'+r[0]+'</td><td>'+r[1]+'</td><td>'+r[2]+'</td><td style="font-size:12px">'+r[3]+'</td></tr>';}).join('')+'</tbody></table>'));

  el_.appendChild(card('Antivirals & Antifungals','#7c3aed','<table><thead><tr style="background:#faf5ff"><th>Drug</th><th>Indication</th><th>Dose</th><th>Duration</th><th>Key Notes</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#7c3aed">'+r[0]+'</td><td style="font-size:12px;color:#6b7280">'+r[1]+'</td><td>'+r[2]+'</td><td>'+r[3]+'</td><td style="font-size:12px">'+r[4]+'</td></tr>';}).join('')+'</tbody></table>'));
  ...
  el_.appendChild(card('Additional Respiratory & GI Drug Reference','#10b981','<table><thead><tr style="background:#f0fdf4"><th>Drug</th><th>Indication</th><th>Dose</th><th>Notes</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#10b981;font-size:13px">'+r[0]+'</td><td style="font-size:12px">'+r[1]+'</td><td style="font-size:12px">'+r[2]+'</td><td style="font-size:11px;color:#6b7280">'+r[3]+'</td></tr>';}).join('')+'</tbody></table>'));
}
...
function tabDrugCardioEndocrine(el_) {
  ...
  el_.appendChild(card('Anticoagulants','#e11d48','<table><thead><tr style="background:#fff1f2"><th>Drug</th><th>Dose</th><th>Route</th><th>Monitoring</th><th>Key Notes</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#e11d48">'+r[0]+'</td><td>'+r[1]+'</td><td>'+r[2]+'</td><td style="font-size:12px;color:#6b7280">'+r[3]+'</td><td style="font-size:12px">'+r[4]+'</td></tr>';}).join('')+'</tbody></table>'));

  el_.appendChild(card('Antiplatelets','#f97316','<table><thead><tr style="background:#fff7ed"><th>Drug</th><th>Dose</th><th>Frequency</th><th>Key Notes</th></tr></thead><tbody>'+[
  ...
  el_.appendChild(card('Antiarrhythmics','#0ea5e9','<table><thead><tr style="background:#f0f9ff"><th>Drug</th><th>Class</th><th>Dose</th><th>Route</th><th>Key Notes</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#0ea5e9">'+r[0]+'</td><td style="font-size:12px;color:#6b7280">'+r[1]+'</td><td>'+r[2]+'</td><td>'+r[3]+'</td><td style="font-size:12px">'+r[4]+'</td></tr>';}).join('')+'</tbody></table>'));

  el_.appendChild(card('Lipid-Lowering Agents','#16a34a','<table><thead><tr style="background:#f0fdf4"><th>Drug</th><th>Dose</th><th>Frequency</th><th>Key Notes</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#16a34a">'+r[0]+'</td><td>'+r[1]+'</td><td>'+r[2]+'</td><td style="font-size:12px">'+r[3]+'</td></tr>';}).join('')+'</tbody></table>'));

  el_.appendChild(card('Thyroid & Endocrine Drugs','#a855f7','<table><thead><tr style="background:#faf5ff"><th>Drug</th><th>Dose</th><th>Frequency</th><th>Key Notes</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#a855f7">'+r[0]+'</td><td>'+r[1]+'</td><td>'+r[2]+'</td><td style="font-size:12px">'+r[3]+'</td></tr>';}).join('')+'</tbody></table>'));

  el_.appendChild(card('Corticosteroids & Bone Drugs','#78350f','<table><thead><tr style="background:#fef3c7"><th>Drug</th><th>Dose</th><th>Frequency</th><th>Key Notes</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#78350f">'+r[0]+'</td><td>'+r[1]+'</td><td>'+r[2]+'</td><td style="font-size:12px">'+r[3]+'</td></tr>';}).join('')+'</tbody></table>'));
  ...
  el_.appendChild(card('Common ARV Regimens in Nigeria (FMOH 2021 Guidelines)','#7c3aed','<table><thead><tr style="background:#faf5ff"><th>Line</th><th>Regimen</th><th>Components</th><th>Key Side Effects</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:600;color:#7c3aed;font-size:12px">'+r[0]+'</td><td style="font-size:12px;font-weight:700">'+r[1]+'</td><td style="font-size:12px">'+r[2]+'</td><td style="font-size:11px;color:#dc2626">'+r[3]+'</td></tr>';}).join('')+'</tbody></table>'));
  el_.appendChild(card('ARV — Critical Drug Interactions on the Ward','#7c3aed','<table><thead><tr style="background:#faf5ff"><th>Ward Drug</th><th>ARV Interaction</th><th>Effect</th><th>Action</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:600;color:#7c3aed;font-size:12px">'+r[0]+'</td><td style="font-size:12px">'+r[1]+'</td><td style="font-size:12px;color:#dc2626">'+r[2]+'</td><td style="font-size:12px">'+r[3]+'</td></tr>';}).join('')+'</tbody></table>'));
  ...
  el_.appendChild(card('Additional Cardio & Endocrine Drug Reference','#e11d48','<table><thead><tr style="background:#fff1f2"><th>Drug</th><th>Indication</th><th>Dose</th><th>Notes</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#e11d48;font-size:13px">'+r[0]+'</td><td style="font-size:12px">'+r[1]+'</td><td style="font-size:12px">'+r[2]+'</td><td style="font-size:11px;color:#6b7280">'+r[3]+'</td></tr>';}).join('')+'</tbody></table>'));
}
...
function tabDrugNeuroMSK(el_) {
  ...
  el_.appendChild(card('Antiepileptics','#6366f1','<table><thead><tr style="background:#eef2ff"><th>Drug</th><th>Indication</th><th>Starting Dose</th><th>Max Dose</th><th>Key Notes</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#6366f1">'+r[0]+'</td><td style="font-size:12px;color:#6b7280">'+r[1]+'</td><td>'+r[2]+'</td><td>'+r[3]+'</td><td style="font-size:12px">'+r[4]+'</td></tr>';}).join('')+'</tbody></table>'));

  el_.appendChild(card('Parkinson\'s Disease Drugs','#8b5cf6','<table><thead><tr style="background:#faf5ff"><th>Drug</th><th>Dose</th><th>Frequency</th><th>Key Notes</th></tr></thead><tbody>'+[
  ...
  el_.appendChild(card('Gout, Rheumatology & MSK','#0891b2','<table><thead><tr style="background:#ecfeff"><th>Drug</th><th>Indication</th><th>Dose</th><th>Key Notes</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#0891b2">'+r[0]+'</td><td style="font-size:12px;color:#6b7280">'+r[1]+'</td><td>'+r[2]+'</td><td style="font-size:12px">'+r[3]+'</td></tr>';}).join('')+'</tbody></table>'));

  el_.appendChild(card('Antihistamines, Sedatives & Misc','#d97706','<table><thead><tr style="background:#fffbeb"><th>Drug</th><th>Dose</th><th>Frequency</th><th>Notes</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#d97706">'+r[0]+'</td><td>'+r[1]+'</td><td>'+r[2]+'</td><td style="font-size:12px">'+r[3]+'</td></tr>';}).join('')+'</tbody></table>'));

  el_.appendChild(card('Extended Antibiotics Reference','#dc2626','<table><thead><tr style="background:#fef2f2"><th>Drug</th><th>Class</th><th>Adult Dose</th><th>Key Notes</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#dc2626">'+r[0]+'</td><td style="font-size:11px;color:#6b7280">'+r[1]+'</td><td>'+r[2]+'</td><td style="font-size:12px">'+r[3]+'</td></tr>';}).join('')+'</tbody></table>'));
  ...
  el_.appendChild(card('Additional Neuro, MSK & Haematinic Drug Reference','#6366f1','<table><thead><tr style="background:#eef2ff"><th>Drug</th><th>Indication</th><th>Dose</th><th>Notes</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#6366f1;font-size:13px">'+r[0]+'</td><td style="font-size:12px">'+r[1]+'</td><td style="font-size:12px">'+r[2]+'</td><td style="font-size:11px;color:#6b7280">'+r[3]+'</td></tr>';}).join('')+'</tbody></table>'));

  // ── DERMATOLOGY ─────────────────────────────────────────────
  el_.appendChild(fromHTML('<h3 style="font-size:15px;font-weight:800;margin:20px 0 10px;color:#ec4899">🧴 Dermatology Drugs</h3>'));
  el_.appendChild(card('Dermatology Drug Reference','#ec4899','<table><thead><tr style="background:#fdf2f8"><th>Drug</th><th>Indication</th><th>Dose / Application</th><th>Notes</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#ec4899;font-size:12px">'+r[0]+'</td><td style="font-size:11px;color:#6b7280">'+r[1]+'</td><td style="font-size:12px">'+r[2]+'</td><td style="font-size:11px">'+r[3]+'</td></tr>';}).join('')+'</tbody></table>'));
  ...
  el_.appendChild(card('Palliative Symptom Control Drugs','#64748b','<table><thead><tr style="background:#f8fafc"><th>Drug</th><th>Symptom</th><th>Dose</th><th>Notes</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#64748b;font-size:12px">'+r[0]+'</td><td style="font-size:11px;color:#6b7280">'+r[1]+'</td><td style="font-size:12px">'+r[2]+'</td><td style="font-size:11px">'+r[3]+'</td></tr>';}).join('')+'</tbody></table>'));
  ...
  el_.appendChild(card('Eye Drop Reference','#0891b2','<table><thead><tr style="background:#f0fdfa"><th>Drug</th><th>Indication</th><th>Dose</th><th>Notes</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#0891b2;font-size:12px">'+r[0]+'</td><td style="font-size:11px;color:#6b7280">'+r[1]+'</td><td style="font-size:12px">'+r[2]+'</td><td style="font-size:11px">'+r[3]+'</td></tr>';}).join('')+'</tbody></table>'));
  ...
  // Receptor table
  el_.appendChild(card('Receptor Types — Location, Effect & Key Drugs','#7c3aed','<table><thead><tr style="background:#faf5ff"><th>Receptor</th><th>Location</th><th>Stimulation Effect</th><th>Agonists (activate)</th><th>Antagonists (block)</th><th>Clinical Use of Blocker/Activator</th></tr></thead><tbody>'+[
...
function tabDrugAntimalarials(el_) {
  ...
  el_.appendChild(card('Severe Malaria Drugs','#dc2626','<table><thead><tr style="background:#fef2f2"><th>Drug</th><th>Dose</th><th>⚗️ Pharmacodynamics</th><th>🎯 Pharmacotherapeutics</th><th>Key Cautions</th></tr></thead><tbody>'+[
    ['Artesunate IV\n(First-line)',
  ...
  el_.appendChild(card('Non-Falciparum & Radical Cure Drugs','#7c3aed','<table><thead><tr style="background:#faf5ff"><th>Drug</th><th>Dose</th><th>⚗️ Pharmacodynamics</th><th>🎯 Pharmacotherapeutics</th><th>Key Cautions</th></tr></thead><tbody>'+[
    ['Chloroquine',
  ...
  el_.appendChild(card('Prophylaxis Drug Reference','#0891b2','<table><thead><tr style="background:#f0fdfa"><th>Drug</th><th>Dose</th><th>⚗️ Pharmacodynamics</th><th>🎯 Pharmacotherapeutics</th><th>Key Cautions</th></tr></thead><tbody>'+[
  ...
  el_.appendChild(card('Quick Comparison — Which Drug, When?','#374151','<table><thead><tr style="background:#f8fafc"><th>Clinical Scenario</th><th>First-Line Drug</th><th>Alternative</th><th>Avoid</th></tr></thead><tbody>'+[
...
function tabDrugDermatology(el_) {
  ...
  el_.appendChild(card('💊 Topical Corticosteroids — Potency Ladder','#ec4899',
    '<table><thead><tr style="background:#fdf4ff"><th>Drug</th><th>Potency</th><th>Use</th><th>Key Caution</th></tr></thead><tbody>'+[
    ...
    ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#ec4899;font-size:13px">'+r[0]+'</td><td style="font-size:12px;font-weight:600">'+r[1]+'</td><td style="font-size:12px">'+r[2]+'</td><td style="font-size:11px;color:#dc2626">'+r[3]+'</td></tr>';}).join('')+'</tbody></table>'
  ));

  el_.appendChild(card('🦠 Topical Antifungals','#8b5cf6',
    '<table><thead><tr style="background:#faf5ff"><th>Drug</th><th>Indication</th><th>How to Use</th><th>Notes</th></tr></thead><tbody>'+[
    ...
    ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#8b5cf6;font-size:13px">'+r[0]+'</td><td style="font-size:12px">'+r[1]+'</td><td style="font-size:12px">'+r[2]+'</td><td style="font-size:11px;color:#6b7280">'+r[3]+'</td></tr>';}).join('')+'</tbody></table>'
  ));
  ...
  el_.appendChild(card('🦟 Antiparasitics — Scabies & Infestations','#f97316',
    ...
    '<table><thead><tr style="background:#fff7ed"><th>Drug</th><th>Indication</th><th>Dose / Application</th><th>Notes</th></tr></thead><tbody>'+[
    ...
    ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#f97316;font-size:13px">'+r[0]+'</td><td style="font-size:12px">'+r[1]+'</td><td style="font-size:12px">'+r[2]+'</td><td style="font-size:11px;color:#6b7280">'+r[3]+'</td></tr>';}).join('')+'</tbody></table>'
  ));

  el_.appendChild(card('🩺 Topical Antibacterials & Wound Care','#16a34a',
    '<table><thead><tr style="background:#f0fdf4"><th>Drug</th><th>Indication</th><th>Application</th><th>Notes</th></tr></thead><tbody>'+[
  ...
  el_.appendChild(card('💊 Systemic Dermatology Drugs','#0ea5e9',
    '<table><thead><tr style="background:#f0f9ff"><th>Drug</th><th>Indication</th><th>Dose</th><th>Notes</th></tr></thead><tbody>'+[
    ...
    ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#0ea5e9;font-size:13px">'+r[0]+'</td><td style="font-size:12px">'+r[1]+'</td><td style="font-size:12px">'+r[2]+'</td><td style="font-size:11px;color:#6b7280">'+r[3]+'</td></tr>';}).join('')+'</tbody></table>'
  ));
}
...
function tabDrugObsGynae(el_) {
  ...
  el_.appendChild(card('🤰 Antenatal — Hypertension in Pregnancy','#dc2626',
    ...
    '<table><thead><tr style="background:#fef2f2"><th>Drug</th><th>Role</th><th>Dose</th><th>Notes</th></tr></thead><tbody>'+[
  ...
  el_.appendChild(card('🍼 Labour, Delivery & PPH','#f97316',
    '<table><thead><tr style="background:#fff7ed"><th>Drug</th><th>Indication</th><th>Dose</th><th>Notes</th></tr></thead><tbody>'+[
  ...
  el_.appendChild(card('💊 Contraception','#8b5cf6',
    '<table><thead><tr style="background:#faf5ff"><th>Method</th><th>Drug</th><th>Dose/Use</th><th>Notes</th></tr></thead><tbody>'+[
    ...
    ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#8b5cf6;font-size:13px">'+r[0]+'</td><td style="font-size:13px;font-weight:600">'+r[1]+'</td><td style="font-size:12px">'+r[2]+'</td><td style="font-size:11px;color:#6b7280">'+r[3]+'</td></tr>';}).join('')+'</tbody></table>'
  ));

  el_.appendChild(card('🩺 Gynaecology','#16a34a',
    '<table><thead><tr style="background:#f0fdf4"><th>Drug</th><th>Indication</th><th>Dose</th><th>Notes</th></tr></thead><tbody>'+[
...
function tabDrugHaematology(el_) {
  ...
  el_.appendChild(card('💊 Anaemia Treatment','#ef4444',
    '<table><thead><tr style="background:#fef2f2"><th>Drug</th><th>Indication</th><th>Dose</th><th>Notes</th></tr></thead><tbody>'+[
    ...
    ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#ef4444;font-size:13px">'+r[0]+'</td><td style="font-size:12px">'+r[1]+'</td><td style="font-size:12px">'+r[2]+'</td><td style="font-size:11px;color:#6b7280">'+r[3]+'</td></tr>';}).join('')+'</tbody></table>'
  ));

  el_.appendChild(card('🩸 Sickle Cell Disease — Specific Drugs','#7c3aed',
    '<table><thead><tr style="background:#faf5ff"><th>Drug</th><th>Role in SCD</th><th>Dose</th><th>Evidence / Notes</th></tr></thead><tbody>'+[
    ...
    ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#7c3aed;font-size:13px">'+r[0]+'</td><td style="font-size:12px">'+r[1]+'</td><td style="font-size:12px">'+r[2]+'</td><td style="font-size:11px;color:#6b7280">'+r[3]+'</td></tr>';}).join('')+'</tbody></table>'
  ));

  el_.appendChild(card('🔩 Iron Chelation','#d97706',
    '<table><thead><tr style="background:#fffbeb"><th>Drug</th><th>Indication</th><th>Dose</th><th>Notes</th></tr></thead><tbody>'+[
    ...
    ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#d97706;font-size:13px">'+r[0]+'</td><td style="font-size:12px">'+r[1]+'</td><td style="font-size:12px">'+r[2]+'</td><td style="font-size:11px;color:#6b7280">'+r[3]+'</td></tr>';}).join('')+'</tbody></table>'
  ));
