...
function tabHTNDetect(el_) {
  ...
  document.getElementById('d-btn').onclick = function() {
    ...
    if(_htnInv.length){
      ...
      _invHtml+='</div>';
      _invHtml+='<table style="width:100%;border-collapse:collapse">';
...
function tabHTNEval(el_) {
  ...
  el_.appendChild(card('Secondary HTN Clues, Causes & Investigation','#dc2626','<table><thead><tr style="background:#fef2f2"><th>Clinical Clue</th><th>Suspected Cause</th><th>First Screening Test</th><th>Prevalence</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-size:12px;font-weight:600">'+r[0]+'</td><td style="font-size:12px;color:#dc2626;font-weight:700">'+r[1]+'</td><td style="font-size:12px">'+r[2]+'</td><td style="font-size:11px;color:#64748b">'+r[3]+'</td></tr>';}).join('')+'</tbody></table>'));
...
function tabLifestyle(el_) {
  ...
  el_.appendChild(card('Expected BP Reductions by Intervention','#8b5cf6',
    '<table><thead><tr style="background:#faf5ff"><th>Intervention</th><th>Target/Dose</th><th>SBP Reduction</th><th>Guideline</th></tr></thead><tbody>'+[
  ...
  sodBody.innerHTML =
    ...
    '</div>'+
    '<table><thead><tr style="background:#f0f9ff"><th>High Sodium — AVOID/LIMIT</th><th>Low Sodium — PREFERRED</th></tr></thead><tbody>'+[
  ...
  paBody.innerHTML =
    ...
    '</div>'+
    '<table><thead><tr style="background:#f0f9ff"><th>Type</th><th>Activity</th><th>Frequency</th><th>Duration</th><th>Intensity</th><th>BP Reduction</th><th>Source</th></tr></thead><tbody>'+[
  ...
  el_.appendChild(card('⚖️ Weight Reduction','#f97316',
    ...
    '<div style="font-size:10px;color:#94a3b8">ESC/ESH 2023</div></div>'+
    '</div>'+
    '<table><thead><tr style="background:#fff7ed"><th>BMI (kg/m²)</th><th>Category</th><th>Action</th></tr></thead><tbody>'+[
  ...
  el_.appendChild(card('🍺 Alcohol Restriction','#d97706',
    '<table><thead><tr style="background:#fffbeb"><th>Group</th><th>Maximum</th><th>BP Benefit</th><th>Source</th></tr></thead><tbody>'+[
  ...
  stBody.innerHTML =
    ...
    '</div>'+
    '<table><thead><tr style="background:#fdf2f8"><th>Activity</th><th>Evidence</th><th>Recommended Duration/Frequency</th><th>BP Effect</th></tr></thead><tbody>'+[
  ...
  el_.appendChild(card('🚭 Smoking Cessation','#dc2626',
    ...
    '</div>'+
    '<table><thead><tr style="background:#fef2f2"><th>Intervention</th><th>Details</th><th>Source</th></tr></thead><tbody>'+[
...
function tabBPTracker(el_) {
  ...
  if (_addPatBtn) _addPatBtn.addEventListener('click', function(){ window._bpAddPatient(); });
    ...
    if (!readings.length) {
      ...
      hBody.innerHTML = '<div style="overflow-x:auto"><table><thead><tr style="background:#f0fdfa"><th>Date</th><th>Time</th><th>BP</th><th>Stage</th><th>Pulse</th><th>Medication</th><th>Notes</th><th>Actions</th></tr></thead><tbody>'+tableRows+'</tbody></table></div>';
    }
...
function tabCVAProtocol(el_) {
  ...
  el_.appendChild(card('Clinical Clues (Not Diagnostic — CT Always Required)','#dc2626','<table><thead><tr style="background:#fef2f2"><th>Feature</th><th style="color:#0891b2">Ischaemic (85%)</th><th style="color:#dc2626">Haemorrhagic (15%)</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:600">'+r[0]+'</td><td style="color:#0369a1">'+r[1]+'</td><td style="color:#dc2626">'+r[2]+'</td></tr>';}).join('')+'</tbody></table>'));
  ...
  el_.appendChild(card('BP Targets by Stroke Type and Treatment','#dc2626','<table><thead><tr style="background:#fef2f2"><th>Scenario</th><th>BP Target</th><th>Rationale</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:600">'+r[0]+'</td><td style="font-weight:700;color:#dc2626">'+r[1]+'</td><td style="font-size:12px">'+r[2]+'</td></tr>';}).join('')+'</tbody></table>'));
  ...
  el_.appendChild(card('NIH Stroke Scale — Severity Classification','#dc2626','<table><thead><tr style="background:#fef2f2"><th>NIHSS Score</th><th>Severity</th><th>Clinical Features</th></tr></thead><tbody>'+[
  ...
  el_.appendChild(card('Post-Stroke Secondary Prevention Bundle','#dc2626','<table><thead><tr style="background:#fef2f2"><th>Intervention</th><th>Indication</th><th>Agent / Target</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700">'+r[0]+'</td><td style="font-size:12px;color:#64748b">'+r[1]+'</td><td style="font-size:12px">'+r[2]+'</td></tr>';}).join('')+'</tbody></table>'));
...
function tabBPMeasurement(el_) {
  ...
  el_.appendChild(card('Recognition and Clinical Significance','#0ea5e9','<table><thead><tr style="background:#f0f9ff"><th>Phenomenon</th><th>Definition</th><th>Prevalence</th><th>Clinical Action</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#0ea5e9">'+r[0]+'</td><td>'+r[1]+'</td><td style="color:#64748b">'+r[2]+'</td><td style="font-size:12px">'+r[3]+'</td></tr>';}).join('')+'</tbody></table>'));
...
function tabSpecialPops(el_) {
  ...
  el_.appendChild(card('SCD + HTN Management','#ef4444','<table><thead><tr style="background:#fef2f2"><th>Aspect</th><th>Guidance</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:600;color:#ef4444;font-size:13px">'+r[0]+'</td><td style="font-size:13px">'+r[1]+'</td></tr>';}).join('')+'</tbody></table>'));
  ...
  el_.appendChild(card('ARV Drug Interactions with Antihypertensives','#7c3aed','<table><thead><tr style="background:#faf5ff"><th>ARV Drug</th><th>Antihypertensive</th><th>Interaction</th><th>Action</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:600;color:#7c3aed;font-size:12px">'+r[0]+'</td><td style="font-size:12px">'+r[1]+'</td><td style="font-size:12px;color:#dc2626">'+r[2]+'</td><td style="font-size:12px;font-weight:600">'+r[3]+'</td></tr>';}).join('')+'</tbody></table>'));
  el_.appendChild(card('HIV + HTN — First-Line Treatment','#7c3aed','<table><thead><tr style="background:#faf5ff"><th>Choice</th><th>Agent</th><th>Reason</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:600;color:#7c3aed;font-size:13px">'+r[0]+'</td><td style="font-size:13px">'+r[1]+'</td><td style="font-size:12px;color:#6b7280">'+r[2]+'</td></tr>';}).join('')+'</tbody></table>'));
