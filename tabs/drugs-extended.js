...
var MOD_META = {
  ...
  DM:     { icon:'🩸',  name:'Diabetes',       sub:'ADA 2024 · DKA/HHS · BG Tracker',                    color:'#ef4444', bg:'rgba(239,68,68,0.12)' },
  SEPSIS: { icon:'🦠',  name:'Sepsis',         sub:'qSOFA · SOFA · Hour-1 Bundle',                        color:'#f97316', bg:'rgba(249,115,22,0.12)' },
