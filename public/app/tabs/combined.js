...
function tabGlycaemicEmergencies(el_) {
  ...
  el_.appendChild(card('At-a-Glance Comparison','#dc2626','<div class="tbl-wrap"><table><thead><tr style="background:#fef2f2"><th>Feature</th><th style="color:#dc2626">DKA</th><th style="color:#d97706">HHS</th><th style="color:#7c3aed">Hypoglycaemia / Insulin Coma</th></tr></thead><tbody>'+[
  ...
  el_.appendChild(card('DKA Severity Classification','#dc2626','<div class="tbl-wrap"><table><thead><tr style="background:#fef2f2"><th>Parameter</th><th style="color:#d97706">Mild</th><th style="color:#ea580c">Moderate</th><th style="color:#dc2626">Severe</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:600">'+r[0]+'</td><td style="color:#d97706">'+r[1]+'</td><td style="color:#ea580c">'+r[2]+'</td><td style="color:#dc2626;font-weight:700">'+r[3]+'</td></tr>';}).join('')+'</tbody></table></div>'));
  ...
  el_.appendChild(card('Grading & Recognition','#7c3aed','<div class="tbl-wrap"><table><thead><tr style="background:#faf5ff"><th>Grade</th><th>BG Level</th><th>Features</th><th>Conscious?</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#7c3aed">'+r[0]+'</td><td>'+r[1]+'</td><td>'+r[2]+'</td><td style="font-weight:600">'+r[3]+'</td></tr>';}).join('')+'</tbody></table></div>'));
  ...
  el_.appendChild(card('Differential Diagnosis — Exclude Before Labelling Psychosis','#0891b2','<div class="tbl-wrap"><table><thead><tr style="background:#f0f9ff"><th>Condition</th><th>How to Exclude</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:600">'+r[0]+'</td><td style="font-size:13px">'+r[1]+'</td></tr>';}).join('')+'</tbody></table></div>'));
