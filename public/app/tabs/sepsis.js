function tabSepsisOverview(el_) {
  ...
  el_.appendChild(card('Mortality by Stage','#991b1b','<div class="tbl-wrap"><table><thead><tr style="background:#fef2f2"><th>Stage</th><th>Approx. Mortality</th><th>Key Feature</th></tr></thead><tbody>'
...
function tabSepsisSeverity(el_) {
  ...
  el_.appendChild(card('Management by Severity','#dc2626','<div class="tbl-wrap"><table><thead><tr style="background:#fef2f2"><th>Stage</th><th>Criteria</th><th>Initial Management</th><th>Escalation</th></tr></thead><tbody>'
  ...
  el_.appendChild(card('Vasopressor Guide (SSC 2021)','#7c3aed','<div class="tbl-wrap"><table><thead><tr style="background:#faf5ff"><th>Agent</th><th>Dose Range</th><th>Role</th><th>Notes</th></tr></thead><tbody>'
...
function tabSepsisSOFA(el_) {
  ...
  el_.appendChild(card('qSOFA Score (1 point each)','#dc2626','<div class="tbl-wrap"><table><thead><tr style="background:#fef2f2"><th>Criterion</th><th>Cut-off</th><th>Points</th></tr></thead><tbody>'+[
  ...
  el_.appendChild(card('SOFA Score Components (0\u20134 points each \u2014 max 24)','#dc2626','<div class="tbl-wrap"><table><thead><tr style="background:#fef2f2"><th>System</th><th>Parameter</th><th>0</th><th>1</th><th>2</th><th>3</th><th>4</th></tr></thead><tbody>'+[
...
function tabSepsisInvestigations(el_) {
  ...
  el_.appendChild(card('Essential Investigations (Send Immediately)','#dc2626','<div class="tbl-wrap"><table><thead><tr style="background:#fef2f2"><th>Investigation</th><th>Why It Matters</th><th>Key Threshold</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700">'+r[0]+'</td><td style="font-size:12px">'+r[1]+'</td><td style="font-size:12px;color:#dc2626;font-weight:600">'+r[2]+'</td></tr>';}).join('')+'</tbody></table></div>'));
}
...
function tabSepsisAntibiotics(el_) {
  ...
  el_.appendChild(card('Typhoid — Treatment by Severity','#f97316','<div class="tbl-wrap"><table><thead><tr style="background:#fff7ed"><th>Severity</th><th>First-line</th><th>Alternative</th><th>Duration</th></tr></thead><tbody>'+[
  ...
  el_.appendChild(card('Severe Malaria — Emergency Treatment','#dc2626','<div class="tbl-wrap"><table><thead><tr style="background:#fef2f2"><th>Parameter</th><th>Detail</th></tr></thead><tbody>'+[
  ...
  el_.appendChild(card('Neonatal Sepsis — Classification & Empiric Treatment','#8b5cf6','<div class="tbl-wrap"><table><thead><tr style="background:#faf5ff"><th>Type</th><th>Timing</th><th>Common Organisms</th><th>Empiric Treatment</th></tr></thead><tbody>'+[
  ...
  ].map(function(r){return '<tr class="tbl-row"><td style="font-weight:700;color:#8b5cf6;font-size:12px">'+r[0]+'</td><td style="font-size:12px">'+r[1]+'</td><td style="font-size:12px">'+r[2]+'</td><td style="font-size:12px">'+r[3]+'</td></tr>';}).join('')+'</tbody></table></div>'));
